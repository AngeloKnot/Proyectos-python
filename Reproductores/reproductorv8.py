...
class ReproductorMusica:
    def __init__(self, ventana_principal):
        ...
        self.etiqueta_metadatos.pack(pady=5)
        ...
        self.boton_retroceder.pack(side=tk.LEFT, padx=20)

        self.boton_adelantar = tk.Button(self.ventana_principal, text="Adelantar", command=self.adelantar, 
                                         bg="#FFC107", fg="black", font=("Arial", 12), padx=10, pady=5)
        self.boton_adelantar.pack(side=tk.LEFT, padx=20)
    ...
    def mostrar_metadatos(self):
        ...
        artista = audio.get("TPE1", "-").text[0] if audio.get("TPE1") else "-"
        titulo = audio.get("TIT2", "-").text[0] if audio.get("TIT2") else "-"
        ano = audio.get("TDRC", "-").text[0] if audio.get("TDRC") else "-"
        genero = audio.get("TCON", "-").text[0] if audio.get("TCON") else "-"
