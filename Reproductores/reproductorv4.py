...
class ReproductorMusica:
    def __init__(self, ventana_principal):
        ...
        self.ventana_principal.geometry("500x450")
        self.ventana_principal.config(bg="#2d2d2d")
    ...
    def abrir_ventana_reproduccion(self):
        if self.archivos_canciones:
            ...
            ventana_reproduccion.geometry("500x450")
            ventana_reproduccion.config(bg="#2d2d2d")

            # Mostrar canción actual
            self.cancion_actual = tk.StringVar()
            self.cancion_actual.set("Ninguna canción seleccionada")

            etiqueta_cancion = tk.Label(ventana_reproduccion, textvariable=self.cancion_actual, bg="#2d2d2d", fg="white", font=("Arial", 14))
            ...
            self.boton_continue = tk.Button(ventana_reproduccion, text="Continuar", command=self.continuar_musica, 
                                            bg="#4CAF50", fg="white", font=("Arial", 12), padx=10, pady=5)
            self.boton_continue.pack(pady=5)
            ...
            self.boton_anterior = tk.Button(ventana_reproduccion, text="Anterior", command=self.retroceder, 
                                            bg="#9E9E9E", fg="white", font=("Arial", 12), padx=10, pady=5)
    ...
    def mostrar_caratula(self, archivo_cancion):
        try:
            ...
            elif archivo_cancion.endswith(".wav"):
                audio = WavPack(archivo_cancion)
