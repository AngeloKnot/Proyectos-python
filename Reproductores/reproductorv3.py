...
class ReproductorMusica:
    def __init__(self, ventana_principal):
        ...
        self.ventana_principal.geometry("500x400")
    ...
    def abrir_ventana_reproduccion(self):
        if self.archivos_canciones:
            ...
            ventana_reproduccion.geometry("500x400")
            ...
            self.lista_reproduccion = tk.Listbox(ventana_reproduccion, selectmode=tk.SINGLE, height=8, width=40)
